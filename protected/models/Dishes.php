...
class Dishes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ref_food_id', 'numerical', 'integerOnly'=>true),
			array('dish_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('dish_id, ref_food_id, dish_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ref_food_id',$this->ref_food_id);
